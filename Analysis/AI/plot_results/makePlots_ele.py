...
sample_names = ["st",  "dy", "qcd", "diboson", "wjets", "ttbar_out","ttbar_ll","ttbar_had","Ttbar_in_1","Ttbar_in_2", "Ttbar_in_3", "Ttbar_in_4"]
...
for sample in sample_names:
    ...
    hist1_2016post[sample] = _file[sample].Get("electron_2016_750_900_prefit/%s"%sample)
...
dataHist1_2016pre=data_f.Get("electron_2016_750_900_prefit/data_obs")
...
for i in range(1, h_ratio.GetNbinsX() + 1):
    ...
    mc_2 = _file[sample].Get("electron_2016_750_900_prefit/TotalBkg")
...
c1.SaveAs("final_electron_AI.pdf")
