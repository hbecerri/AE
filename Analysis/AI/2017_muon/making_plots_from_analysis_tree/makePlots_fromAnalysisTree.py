...
histograms = {
              ...
              "top_pt": ["p_{T} (t)", "Events", 25, [0,1200]],
              "antitop_pt": ["p_{T} #bar{t}", "Events", 25, [0,1200]],
}  

sample_names = ["Diboson_2017","DYJetsToLL_M-50_HT_2017","ST_2017","WJetsToLNu_2017","TTToSemiLeptonic_2017"]
...
for sample in sample_names:
		...
		tree_MC[sample]=_file[sample].Get("AnalysisTree")
 	        ...
 	        tree_MC[sample].Draw("%s>>h2_%s(%i,%i,%f)"%(histName,sample,histograms[histName][2],histograms[histName][3][0],histograms[histName][3][1]),"eventweight*(DeepttagN <= 1 && btagN >= 1 && M_tt > 500 && Boost_Ak4_add_pt > 0  && Mu_pt > 55  && N_Ak4 > 2)")
                ...
                if(sample == "Diboson_2017" or sample == "DYJetsToLL_M-50_HT_2017" or sample == "QCD_HT_2017" or sample == "ST_2017"):
