...
text2workspace.py muon_2016postVFP_900_Inf.txt -o muon_2016postVFP_900_Inf.root  -P HiggsAnalysis.CombinedLimit.PhysicsModel:multiSignalModel -m 125 --PO map='.*/TTToSemiLeptonic_1:r_1[1,0,20]' --PO map='.*/TTToSemiLeptonic_2:r_2[1,0,20]' --PO map='.*/TTToSemiLeptonic_3:r_3[1,0,20]' --PO map='.*/TTToSemiLeptonic_4:r_4[1,0,20]' --PO verbose
