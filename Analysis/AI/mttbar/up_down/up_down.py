...
fin = TFile('/nfs/dust/cms/user/hugobg/UHH2_UL/CMSSW_10_6_28/src/UHH2/Analysis/AI/mttbar/%s/script/Input_undfolding_data_.root'%(argv[1]), 'open')
nominalhist = {}
nominalhistDraw = {}
systvarhist = {}
systvarhistDraw = {}
...
for samp in samplelist:
    for syst in systematic_direction:
        ...
        if('2018' in argv[1]):  latex2.DrawLatex(2.9,a*1.52,"58.80 fb^{-1} (13 TeV)")
        ...
        canvas_Bkg[samp+syst].SaveAs(argv[1]+samp+syst+'.pdf')
