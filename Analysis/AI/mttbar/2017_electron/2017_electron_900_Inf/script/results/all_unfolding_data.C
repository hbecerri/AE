...
//--------Unfold----------??
       ...
       string selcuts_boosted_central_1 = "(Ele_pt > 80 && DeepttagN <= 1 && btagN >= 1 && M_tt > 900 && M_tt < 9000 && chi2 < 30 && Boost_Ak4_add_pt > 0 && ttj_rapidity<0)";
       string selcuts_boosted_central_2 = "(Ele_pt > 80 && DeepttagN <= 1 && btagN >= 1 && M_tt > 900 && M_tt < 9000 && chi2 < 30 && Boost_Ak4_add_pt > 0 && ttj_rapidity>0)";
...
//        string systs[] = {"1"};
        ...
        for(const string &syst : systs){
            ...
            string selcuts_boosted_central_1 = "(Ele_pt > 80 && DeepttagN <= 1 && btagN >= 1 && M_tt > 900 && M_tt < 9000 && chi2 < 30 && Boost_Ak4_add_pt > 0 && ttj_rapidity>0 && Gen_ttj_Rapidity>0)";
            string selcuts_boosted_central_2 = "(Ele_pt > 80 && DeepttagN <= 1 && btagN >= 1 && M_tt > 900 && M_tt < 9000 && chi2 < 30 && Boost_Ak4_add_pt > 0 && ttj_rapidity>0 && Gen_ttj_Rapidity<0)";
            string selcuts_boosted_central_3 = "(Ele_pt > 80 && DeepttagN <= 1 && btagN >= 1 && M_tt > 900 && M_tt < 9000 && chi2 < 30 && Boost_Ak4_add_pt > 0 && ttj_rapidity<0 && Gen_ttj_Rapidity>0)";
            string selcuts_boosted_central_4 = "(Ele_pt > 80 && DeepttagN <= 1 && btagN >= 1 && M_tt > 900 && M_tt < 9000 && chi2 < 30 && Boost_Ak4_add_pt > 0 && ttj_rapidity<0 && Gen_ttj_Rapidity<0)";
