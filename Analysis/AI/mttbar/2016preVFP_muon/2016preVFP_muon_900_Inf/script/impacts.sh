...
text2workspace.py muon_2016_900_Inf.txt -o muon_2016_900_Inf.root  -P HiggsAnalysis.CombinedLimit.PhysicsModel:multiSignalModel -m 125 --PO map='.*/TTToSemiLeptonic_1:r_1[1,0,20]' --PO map='.*/TTToSemiLeptonic_2:r_2[1,0,20]' --PO map='.*/TTToSemiLeptonic_3:r_3[1,0,20]' --PO map='.*/TTToSemiLeptonic_4:r_4[1,0,20]' --PO verbose
...
export SetParametersExplicit="r_1=1,r_2=1,r_4=1,r_4=1"
export SetParameterRanges="r_1=0.5,2:r_2=0.5,2:r_4=0.5,2:r_4=0.5,2"
