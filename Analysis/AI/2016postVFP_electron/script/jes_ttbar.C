...
//--------Unfold----------??
 ...
 difference_4_20 = TMath::Abs(nominal_4_20 - variation_4_20);
        ...
        TH1F* Ttbar_1_down = new TH1F("Ttbar_1_down", "Merged histogram", newrec*4,0,newrec*4);
        TH1F* Ttbar_2_down = new TH1F("Ttbar_2_down", "Merged histogram", newrec*4,0,newrec*4);
        TH1F* Ttbar_1_up   = new TH1F("Ttbar_1_up",   "Merged histogram", newrec*4,0,newrec*4);
        TH1F* Ttbar_2_up   = new TH1F("Ttbar_2_up",   "Merged histogram", newrec*4,0,newrec*4); 
        TH1F* Ttbar_3_down = new TH1F("Ttbar_3_down", "Merged histogram", newrec*4,0,newrec*4);
        TH1F* Ttbar_4_down = new TH1F("Ttbar_4_down", "Merged histogram", newrec*4,0,newrec*4);
        TH1F* Ttbar_3_up   = new TH1F("Ttbar_3_up",   "Merged histogram", newrec*4,0,newrec*4);
        TH1F* Ttbar_4_up   = new TH1F("Ttbar_4_up",   "Merged histogram", newrec*4,0,newrec*4);
