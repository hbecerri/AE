...
datacard.write("shapes data_obs  *  /nfs/dust/cms/user/hugobg/UHH2_UL/CMSSW_10_6_28/src/UHH2/Analysis/AI/2016postVFP_electron/script/Input_undfolding_data.root $PROCESS\n")
datacard.write("shapes *         *  /nfs/dust/cms/user/hugobg/UHH2_UL/CMSSW_10_6_28/src/UHH2/Analysis/AI/2016postVFP_electron/script/Input_undfolding_data.root $PROCESS_nominal $PROCESS_$SYSTEMATIC\n")
...
datacard.write("\n")
datacard.write("process ")
for ireco in range(-3,len(proc)-3):
    ...
    for name2 in proc:
        ...
        for element in dir2:
            ...
            if(el.find(name2+'_'+name+'Up') != -1):
                existe = '1 '
        if('Ttbar_in' not in name2 and 'PDF' in name): existe = '- '
