...
histograms = {
              ...
              "Boost_top_E": ["E(t)", "Events", 25, [0,1200]],
              "Boost_top_eta": ["#eta (t)", "Events", 25, [-3,3]],
              "Boost_top_phi": ["#phi (t)", "Events", 25, [-3,3]],
              "Boost_top_pt": ["p_{T} (t)", "Events", 25, [0,1200]],
              "Boost_antitop_E": ["E (#bar{t})", "Events", 25, [0,1200]],
              "Boost_antitop_eta": ["#eta (#bar{t})", "Events", 25, [-3,3]],
              "Boost_antitop_phi": ["#phi #bar{t}", "Events", 25, [-3,3]],
              "Boost_antitop_pt": ["p_{T} #bar{t}", "Events", 25, [0,1200]],
              "Boost_Ak4_add_E": ["E (j_{add})", "Events", 25, [0,1200]],
              "Boost_Ak4_add_eta": ["#eta (j_{add})", "Events", 25, [-3,3]],
              "Boost_Ak4_add_phi": ["#phi (j_{add})", "Events", 25, [-3,3]],
              "Boost_Ak4_add_pt": ["p_{T} (j_{add})", "Events", 25, [0,1200]],
              "MET_pt": ["MET", "Events", 25, [0,1200]],
              ...
              "Mu_pt": ["p_{T} (#mu)", "Events", 25, [50,800]],
              "N_Ak4": ["N_{jets}", "Events", 10, [0,10]],
} 


sample_names = ["DYJetsToLL_M-50_HT_2016preVFP","ST_2016preVFP","WJetsToLNu_2016preVFP","TTToSemiLeptonic_2016preVFP"]
...
for sample in sample_names:
		...
		tree_MC[sample]=_file[sample].Get("AnalysisTree")
 	        ...
 	        tree_MC[sample].Draw("%s>>h2_%s(%i,%i,%f)"%(histName,sample,histograms[histName][2],histograms[histName][3][0],histograms[histName][3][1]),"eventweight*(chi2 < 30 && Boost_Ak4_add_pt > 0 && btagN > =1)")
...
tree.Draw("%s>>dat_hist(%i,%i,%f)"%(histName,histograms[histName][2],histograms[histName][3][0],histograms[histName][3][1]),"1*(chi2 < 30 && Boost_Ak4_add_pt > 0 && btagN > =1)")
