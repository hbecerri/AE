...
_fileDir ="/nfs/dust/cms/user/hugobg/analysis/muon/"
...
histograms = {
              ...
              "top_pt": ["p_{T}(t)", "Events", 25, [10, 1200]],
              "antitop_pt": ["p_{T}(#bar{t})", "Events", 25, [10, 1200]],
}  

sample_names = ["Diboson_2018","QCD_HT_2018","DYJetsToLL_M-50_HT_2018","ST_2018","WJetsToLNu_2018","TTToSemiLeptonic_2018"]
...
for sample in sample_names:
		...
		tree_MC[sample]=_file[sample].Get("AnalysisTree")
 	        ...
 	        tree_MC[sample].Draw("%s>>h2_%s(%i,%i,%f)"%(histName,sample,histograms[histName][2],histograms[histName][3][0],histograms[histName][3][1]),"eventweight*(DeepttagN <= 1 && btagN >= 1 && M_tt > 500 && Boost_Ak4_add_pt > 0 && Mu_pt > 55 && N_Ak4 > 2)")
#                tree_MC[sample].Draw("%s>>h2_%s(%i,%i,%f)"%(histName,sample,histograms[histName][2],histograms[histName][3][0],histograms[histName][3][1]),"eventweight*(Boost_Ak4_add_pt > 100 && Mu_pt > 55 && DeepwtagN == 1 && DeepttagN==0)")
                hist1_[sample] = tree_MC[sample].GetHistogram()
#/weight_toppt_nominal
                if(sample == "DYJetsToLL_M-50_HT_2018" or sample == "QCD_HT_2018" or sample == "ST_2018" or sample == "Diboson_2018"):
...
tree.Draw("%s>>dat_hist(%i,%i,%f)"%(histName,histograms[histName][2],histograms[histName][3][0],histograms[histName][3][1]),"1*(DeepttagN <= 1 && btagN >= 1 && M_tt > 500 && Boost_Ak4_add_pt > 0  && Mu_pt > 55  && N_Ak4 > 2)")
#tree.Draw("%s>>dat_hist(%i,%i,%f)"%(histName,histograms[histName][2],histograms[histName][3][0],histograms[histName][3][1]),"1*(Boost_Ak4_add_pt > 100 && Mu_pt > 55 && DeepwtagN == 1 && DeepttagN==0)")
