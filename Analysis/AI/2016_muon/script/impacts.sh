...
text2workspace.py muon_2016_750_900.txt -o muon_2016_750_900.root  -P HiggsAnalysis.CombinedLimit.PhysicsModel:multiSignalModel -m 125 --PO map='.*/Ttbar_in_1:r_1[1,0,20]' --PO map='.*/Ttbar_in_2:r_2[1,0,20]'  --PO map='.*/Ttbar_in_3:r_3[1,0,20]' --PO map='.*/Ttbar_in_4:r_4[1,0,20]' --PO verbose

#text2workspace.py electron_2018_750_900.txt -o electron_2018_750_900.root  -P HiggsAnalysis.CombinedLimit.PhysicsModel:multiSignalModel -m 125 --PO map='.*/Ttbar_in_1:r_1[1,0,20]' --PO map='.*/Ttbar_in_2:r_2[1,0,20]'  --PO map='.*/Ttbar_in_3:r_3[1,0,20]' --PO map='.*/Ttbar_in_4:r_4=expr;;r_4("-5541/5893*@0 + 6770/5893*@1*(100+@3)/(100-@3) + 5894/5893*@2*(100+@3)/(100-@3)",r_1,r_2,r_3,IA[-5.1,-5,5])'    --PO verbose
...
#export SetParametersExplicit="r_1=1,r_2=1,r_3=1,IA=-5.1"
...
export SetParameterRanges="r_1=0.5,2:r_2=0.5,2:r_3=0.0,2:r_4=0.0,2"
