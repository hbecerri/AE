...
samplelist = {'TTToSemiLeptonic_1','TTToSemiLeptonic_2', 'TTToSemiLeptonic_3', 'TTToSemiLeptonic_4'}
...
for samp in samplelist:
    for syst in systematic_direction:
        ...
        for i in range(1, systvarhist[samp+syst+'Up2'].GetNbinsX() + 1):
            systvarhist[samp+syst+'Up2'].SetBinError(i,systvarhist[samp+syst+'Up2'].GetBinError(i)*1.77)
            systvarhist[samp+syst+'Down2'].SetBinError(i,systvarhist[samp+syst+'Down2'].GetBinError(i)*1.77)
        ...
        legend.AddEntry(systvarhistDraw[samp+syst+'Up'],'ML Up','lp')
        legend.AddEntry(systvarhistDraw[samp+syst+'Down'],'ML Down','lp')
        ...
        latex2.DrawLatex(2.9,a*1.52,"16.81 fb^{-1} (13 TeV)")
        ...
        canvas_Bkg[samp+syst].SaveAs(samp+syst+'_2016postmuon.pdf')
