...
text2workspace.py muon_2016postVFP_750_900.txt -o muon_2016postVFP_750_900.root  -P HiggsAnalysis.CombinedLimit.PhysicsModel:multiSignalModel -m 125 --PO map='.*/Ttbar_in_1:r_1[1,0,20]' --PO map='.*/Ttbar_in_2:r_2[1,0,20]'  --PO map='.*/Ttbar_in_3:r_3[1,0,20]' --PO map='.*/Ttbar_in_4:r_4[1,0,20]' --PO verbose
