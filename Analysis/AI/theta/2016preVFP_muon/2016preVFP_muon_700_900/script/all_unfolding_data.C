...
//----obetener_toda_la_informacion_de_entrada--------??
    ...
    chreco_ttbar_semi->Add(Form("/nfs/dust/cms/user/hugobg/analysis/muon/uhh2.AnalysisModuleRunner.MC.%s_2016preVFP.root/AnalysisTree",text.c_str()));
...
//--------Unfold----------??
       ...
       chreco_data->Add("/nfs/dust/cms/user/hugobg/analysis/muon/uhh2.AnalysisModuleRunner.DATA.DATA_SingleMuon_Run2016preVFP.root/AnalysisTree");
       TTree *treereco_data = (TTree*) chreco_data;
 
       TH1F *Back_1 = new TH1F("Back_1","",2,-1,1);
       TH1F *Back_2 = new TH1F("Back_2","",2,-1,1);
       string selcuts_boosted_central_1 = "(Mu_pt > 55 && DeepttagN <= 1 && btagN >= 1 && M_tt > 500 && angle_theta_opt > 0.7854 && angle_theta_opt < 2.3562 && chi2 < 30 && Boost_Ak4_add_pt > 0 && ttj_rapidity<0)";
       string selcuts_boosted_central_2 = "(Mu_pt > 55 && DeepttagN <= 1 && btagN >= 1 && M_tt > 500 && angle_theta_opt > 0.7854 && angle_theta_opt < 2.3562 && chi2 < 30 && Boost_Ak4_add_pt > 0 && ttj_rapidity>0)";
...
//        string systs[] = {"1"};
        ...
        for(const string &syst : systs){
            ...
            string selcuts_boosted_central_1 = "(Mu_pt > 55 && DeepttagN <= 1 && btagN >= 1 && M_tt > 500 && angle_theta_opt > 0.7854 && angle_theta_opt < 2.3562 && chi2 < 30 && Boost_Ak4_add_pt > 0 && ttj_rapidity>0 && Gen_ttj_Rapidity>0)";
            string selcuts_boosted_central_2 = "(Mu_pt > 55 && DeepttagN <= 1 && btagN >= 1 && M_tt > 500 && angle_theta_opt > 0.7854 && angle_theta_opt < 2.3562 && chi2 < 30 && Boost_Ak4_add_pt > 0 && ttj_rapidity>0 && Gen_ttj_Rapidity<0)";
            string selcuts_boosted_central_3 = "(Mu_pt > 55 && DeepttagN <= 1 && btagN >= 1 && M_tt > 500 && angle_theta_opt > 0.7854 && angle_theta_opt < 2.3562 && chi2 < 30 && Boost_Ak4_add_pt > 0 && ttj_rapidity<0 && Gen_ttj_Rapidity>0)";
            string selcuts_boosted_central_4 = "(Mu_pt > 55 && DeepttagN <= 1 && btagN >= 1 && M_tt > 500 && angle_theta_opt > 0.7854 && angle_theta_opt < 2.3562 && chi2 < 30 && Boost_Ak4_add_pt > 0 && ttj_rapidity<0 && Gen_ttj_Rapidity<0)";
