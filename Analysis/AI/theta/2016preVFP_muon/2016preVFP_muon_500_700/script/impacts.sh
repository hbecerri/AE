...
text2workspace.py muon_2016_500_700.txt -o muon_2016_500_700.root  -P HiggsAnalysis.CombinedLimit.PhysicsModel:multiSignalModel -m 125 --PO map='.*/TTToSemiLeptonic_1:r_1[1,0,20]' --PO map='.*/TTToSemiLeptonic_2:r_2[1,0,20]' --PO map='.*/TTToSemiLeptonic_3:r_3[1,0,20]' --PO map='.*/TTToSemiLeptonic_4:r_4[1,0,20]' --PO verbose

#text2workspace.py muon_2016_750_900.txt -o muon_2016_750_900.root  -P HiggsAnalysis.CombinedLimit.PhysicsModel:multiSignalModel -m 125 --PO map='.*/TTToSemiLeptonic_1:rneg[1,0,20]' --PO map='.*/TTToSemiLeptonic_2:rpos=expr;;rpos("12466/12563*@0*(100+@1)/(100-@1)",rneg,AE[0.03,-5,5])' --PO verbose
...
export WORKSPACE=muon_2016_500_700.root
export VERBOSITY=0

#export SetParameters="rgx{r.+}=1,AE=0.03"
#export SetParametersExplicit="rneg=1,AE=0.03"
