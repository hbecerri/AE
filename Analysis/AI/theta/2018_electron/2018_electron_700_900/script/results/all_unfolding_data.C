...
//----obetener_toda_la_informacion_de_entrada--------??
    ...
    chreco_ttbar_semi->Add(Form("/nfs/dust/cms/user/hugobg/analysis/electron/uhh2.AnalysisModuleRunner.MC.%s_2018.root/AnalysisTree",text.c_str()));
...
//    Float_t bins_gen[] = {0,100,200,300,400,900,600,900,800,900,1000};
//    Float_t new_rec[]  = {0,100,200,300,400,900,600,900,800,900,1000};
...
//--------Unfold----------??
       ...
       chreco_data->Add("/nfs/dust/cms/user/hugobg/analysis/electron/uhh2.AnalysisModuleRunner.DATA.DATA_SingleMuon_Run2018.root/AnalysisTree");
       TTree *treereco_data = (TTree*) chreco_data;

       TH1F *Back_1 = new TH1F("Back_1","",2,-1,1);
       TH1F *Back_2 = new TH1F("Back_2","",2,-1,1);
       string selcuts_boosted_central_1 = "(Ele_pt > 80 && DeepttagN <= 1 && btagN >= 1 && M_tt > 500 && angle_theta_opt > 0.7854 && angle_theta_opt < 2.3562 && chi2 < 30 && Boost_Ak4_add_pt > 0 && ttj_rapidity<0)";
       string selcuts_boosted_central_2 = "(Ele_pt > 80 && DeepttagN <= 1 && btagN >= 1 && M_tt > 500 && angle_theta_opt > 0.7854 && angle_theta_opt < 2.3562 && chi2 < 30 && Boost_Ak4_add_pt > 0 && ttj_rapidity>0)";
...
//        string systs[] = {"1"};
        ...
        for(const string &syst : systs){
            ...
            string selcuts_boosted_central_1 = "(Ele_pt > 80 && DeepttagN <= 1 && btagN >= 1 && M_tt > 500 && angle_theta_opt > 0.7854 && angle_theta_opt < 2.3562 && chi2 < 30 && Boost_Ak4_add_pt > 0 && ttj_rapidity>0 && Gen_ttj_Rapidity>0)";
            string selcuts_boosted_central_2 = "(Ele_pt > 80 && DeepttagN <= 1 && btagN >= 1 && M_tt > 500 && angle_theta_opt > 0.7854 && angle_theta_opt < 2.3562 && chi2 < 30 && Boost_Ak4_add_pt > 0 && ttj_rapidity>0 && Gen_ttj_Rapidity<0)";
            string selcuts_boosted_central_3 = "(Ele_pt > 80 && DeepttagN <= 1 && btagN >= 1 && M_tt > 500 && angle_theta_opt > 0.7854 && angle_theta_opt < 2.3562 && chi2 < 30 && Boost_Ak4_add_pt > 0 && ttj_rapidity<0 && Gen_ttj_Rapidity>0)";
            string selcuts_boosted_central_4 = "(Ele_pt > 80 && DeepttagN <= 1 && btagN >= 1 && M_tt > 500 && angle_theta_opt > 0.7854 && angle_theta_opt < 2.3562 && chi2 < 30 && Boost_Ak4_add_pt > 0 && ttj_rapidity<0 && Gen_ttj_Rapidity<0)";
