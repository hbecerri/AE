...
stackList = {"TTToSemiLeptonic_1_nominal":[kRed], "TTToSemiLeptonic_2_nominal":[kRed], "TTToSemiLeptonic_3_nominal":[kRed],"TTToSemiLeptonic_4_nominal":[kRed],"wjetstolnu_nominal":[kGreen], "dyjetstoll_m-50_ht_nominal":[kYellow], "st_nominal":[kBlue], "qcd_ht_nominal":[kOrange], "diboson_nominal":[kTeal], "zgammatojjgamma_nominal":[kCyan+2], "wgtolnug_nominal":[kViolet], "gjets_int_nominal":[kRed-2]}
...
sample_names = ["wjetstolnu_nominal", "st_nominal",  "dyjetstoll_m-50_ht_nominal", "qcd_ht_nominal","TTToSemiLeptonic_1_nominal","TTToSemiLeptonic_2_nominal","TTToSemiLeptonic_3_nominal","TTToSemiLeptonic_4_nominal"]
