...
latex.DrawLatex(2.5,20000,"#theta_{j} #in [0,0.25#pi]");
latex.DrawLatex(5.5,20000,"#theta_{j} #in [0.25#pi,0.75#pi]");
latex.DrawLatex(9.5,20000,"#theta_{j} #in [0.75#pi,#pi]");
...
for i in range(1,total_n_bins+1):
    if(i < 5):              errorband2.SetBinError(i,2*math.sqrt(data_bin1.GetBinError(i)**2 + bkg_bin1.GetBinError(i)**2) /bkg_bin1.GetBinContent(i))
    if(i >=5 and i < 8):   errorband2.SetBinError(i,2*math.sqrt(data_bin2.GetBinError(i-4)**2+bkg_bin2.GetBinError(i-4)**2)/bkg_bin2.GetBinContent(i-4))
    if(i==8):              errorband2.SetBinError(i,2*math.sqrt(data_bin2.GetBinError(4)**2+bkg_bin2.GetBinError(4)**2)/bkg_bin2.GetBinContent(4))
    if(i > 8 and i < 12):  errorband2.SetBinError(i,2*math.sqrt(data_bin3.GetBinError(i-8)**2+bkg_bin3.GetBinError(i-8)**2)/bkg_bin3.GetBinContent(i-8))
    if(i==12):              errorband2.SetBinError(i,2*math.sqrt(data_bin3.GetBinError(4)**2+bkg_bin3.GetBinError(4)**2)/bkg_bin3.GetBinContent(4))
