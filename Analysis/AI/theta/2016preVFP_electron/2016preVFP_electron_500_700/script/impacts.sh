...
text2workspace.py electron_2016_500_700.txt -o electron_2016_500_700.root  -P HiggsAnalysis.CombinedLimit.PhysicsModel:multiSignalModel -m 125 --PO map='.*/TTToSemiLeptonic_1:r_1[1,0,20]' --PO map='.*/TTToSemiLeptonic_2:r_2[1,0,20]' --PO map='.*/TTToSemiLeptonic_3:r_3[1,0,20]' --PO map='.*/TTToSemiLeptonic_4:r_4[1,0,20]' --PO verbose
...
export WORKSPACE=electron_2016_500_700.root
export VERBOSITY=0
