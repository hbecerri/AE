...
# Open the ROOT file
file_name = "/nfs/dust/cms/user/hugobg/analysis/electron///workdir_Analysis_UL18_electron/uhh2.AnalysisModuleRunner.MC.TTToSemiLeptonic_UL18_37.root"
...
hist_title = "2D Histogram; top_E - antitop_E; newgen_top_E - newgen_antitop_E"
nbins_x = 2
x_min = -2000
x_max = 2000
nbins_y = 2
...
expr_x = "(top_E - antitop_E)"
expr_y = "(newgentop_E - newgenantitop_E)"

# Draw the 2D histogram
tree.Draw(expr_y + ":" + expr_x + ">>" + hist_name, "", "COLZ")
...
canvas.SaveAs("2d_histogram_with_purity_stability.png")
