...
# Open the ROOT file
file_name = "/nfs/dust/cms/user/hugobg/analysis/electron/workdir_Analysis_UL16preVFP_electron/uhh2.AnalysisModuleRunner.MC.TTToSemiLeptonic_UL16preVFP_10.root"
