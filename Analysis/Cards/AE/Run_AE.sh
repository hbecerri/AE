...
text2workspace.py AE_750.txt -o AE_750.root  -P HiggsAnalysis.CombinedLimit.PhysicsModel:multiSignalModel -m 125 --PO map='.*/TTToSemiLeptonic_1:rneg[1,0,20]' --PO map='.*/TTToSemiLeptonic_2:r_pos=expr;;r_pos("52489.2665/51699.2089*@0*(100+@1)/(100-@1)",rneg,AE[-0.76,-10,10])' --PO verbose 
...
export SetParameters="rgx{r.+}=1,AE=-0.76"
export SetParametersExplicit="rneg=1,AE=-0.76"
