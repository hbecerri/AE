...
void triger_ele_2016post()
{

TFile* file_wjets = new  TFile("/nfs/dust/cms/user/hugobg/UHH2_UL/CMSSW_10_6_28/src/UHH2/ZprimeSemiLeptonic/macros/src/files_EleTrigger/ElecTriggerSFUL16postVFP.root");
...
h2->Draw("same");
h3->Draw("same");
c1->SaveAs("2016postVFP_ele_low.pdf");
...
h21->Draw("same");
h31->Draw("same");
c11->SaveAs("2016postVFP_ele_mid.pdf");
...
h22->Draw("same");
h32->Draw("same");
c12->SaveAs("2016postVFP_ele_high.pdf");
