...
datacard.write("shapes data_obs  *  /nfs/dust/cms/user/hugobg/UHH2_UL/CMSSW_10_6_28/src/UHH2/Analysis/AE/2016postVFP_muon_BDT/script/Input_undfolding_data.root $PROCESS\n")
datacard.write("shapes *         *  /nfs/dust/cms/user/hugobg/UHH2_UL/CMSSW_10_6_28/src/UHH2/Analysis/AE/2016postVFP_muon_BDT/script/Input_undfolding_data.root $PROCESS_nominal $PROCESS_$SYSTEMATIC\n")
