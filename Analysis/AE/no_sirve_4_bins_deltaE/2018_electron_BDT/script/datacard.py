...
datacard.write("shapes data_obs  *  /nfs/dust/cms/user/hugobg/UHH2_UL/CMSSW_10_6_28/src/UHH2/Analysis/AE/2018_electron_BDT/script/Input_undfolding_data.root $PROCESS\n")
datacard.write("shapes *         *  /nfs/dust/cms/user/hugobg/UHH2_UL/CMSSW_10_6_28/src/UHH2/Analysis/AE/2018_electron_BDT/script/Input_undfolding_data.root $PROCESS_nominal $PROCESS_$SYSTEMATIC\n")
...
for xx in range(len(proc)):
    datacard.write('1.02 ')
datacard.write("\n")
datacard.write('luminosity_1818 lnN ')
for xx in range(len(proc)):
    datacard.write('1.006 ')
datacard.write("\n")
datacard.write('luminosity_161818 lnN ')
for xx in range(len(proc)):
