...
N_reco_bins = 0
datacard=open("muon_2016preVFP_750_900.txt","w")
...
datacard.write("shapes data_obs  *  /nfs/dust/cms/user/hugobg/UHH2_UL/CMSSW_10_6_28/src/UHH2/Analysis/AE/2016preVFP_muon_BDT/script/Input_undfolding_data.root $PROCESS\n")
datacard.write("shapes *         *  /nfs/dust/cms/user/hugobg/UHH2_UL/CMSSW_10_6_28/src/UHH2/Analysis/AE/2016preVFP_muon_BDT/script/Input_undfolding_data.root $PROCESS_nominal $PROCESS_$SYSTEMATIC\n")

datacard.write("----------------\n")

datacard.write("bin muon_2016preVFP_750_900")
datacard.write("\n")
...
for ireco in range(1,len(proc)+1):
    datacard.write("muon_2016preVFP_750_900 ")
datacard.write("\n")
datacard.write("process ")
datacard.write("Ttbar_in_1 ")
datacard.write("Ttbar_in_2 ")
datacard.write("Ttbar_in_3 ")
datacard.write("Ttbar_in_4 ")
