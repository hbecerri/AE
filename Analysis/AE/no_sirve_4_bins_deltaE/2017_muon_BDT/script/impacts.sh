...
#text2workspace.py  muon_2017_750_900.txt -o muon_2017_750_900.root  -P HiggsAnalysis.CombinedLimit.PhysicsModel:multiSignalModel -m 125 --PO map='.*/Ttbar_in_1:r_1[1,0,20]' --PO map='.*/Ttbar_in_2:r_2[1,0,20]' --PO verbose

text2workspace.py muon_2017_750_900.txt -o muon_2017_750_900.root  -P HiggsAnalysis.CombinedLimit.PhysicsModel:multiSignalModel -m 125 --PO map='.*/Ttbar_in_1:rneg[1,0,20]' --PO map='.*/Ttbar_in_2:rpos=expr;;rpos("27065/27071*@0*(100+@1)/(100-@1)",rneg,AE[0.01,-5,5])' --PO verbose
