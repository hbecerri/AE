...
//----obetener_toda_la_informacion_de_entrada--------??
    ...
    chreco_ttbar_semi->Add(Form("/nfs/dust/cms/user/hugobg/analysis/electron/BDT/2017_electron/%s.root/Events",text.c_str()));
...
//--------Unfold----------??
       ...
       chreco_data->Add("/nfs/dust/cms/user/hugobg/analysis/electron/BDT/2017_electron/data.root/Events");
       ...
       string selcuts_boosted_central_1 = "(N_Ak4 >=3 && Ele_pt > 55 && DeepttagN <= 1 && btagN >= 1 && M_tt > 450 &&chi2 < 30 && Ak4_add_pt > 100 && angle_theta_opt > 0.25*3.1459 && angle_theta_opt < 0.6*3.1459 && (Boost_top_E - Boost_antitop_E) < -100)";
       string selcuts_boosted_central_2 = "(N_Ak4 >=3 && Ele_pt > 55 && DeepttagN <= 1 && btagN >= 1 && M_tt > 450 &&chi2 < 30 && Ak4_add_pt > 100 && angle_theta_opt > 0.25*3.1459 && angle_theta_opt < 0.6*3.1459 && (Boost_top_E - Boost_antitop_E) > -100 && (Boost_top_E - Boost_antitop_E) < 0)";
       string selcuts_boosted_central_3 = "(N_Ak4 >=3 && Ele_pt > 55 && DeepttagN <= 1 && btagN >= 1 && M_tt > 450 &&chi2 < 30 && Ak4_add_pt > 100 && angle_theta_opt > 0.25*3.1459 && angle_theta_opt < 0.6*3.1459 && (Boost_top_E - Boost_antitop_E) > 0 && (Boost_top_E - Boost_antitop_E) < 100)";
       string selcuts_boosted_central_4 = "(N_Ak4 >=3 && Ele_pt > 55 && DeepttagN <= 1 && btagN >= 1 && M_tt > 450 &&chi2 < 30 && Ak4_add_pt > 100 && angle_theta_opt > 0.25*3.1459 && angle_theta_opt < 0.6*3.1459 && (Boost_top_E - Boost_antitop_E) > 100)";
...
string systs[] = {"1"};
        ...
        for(const string &syst : systs){
           ...
           TH1F *Back_4 = new TH1F("Back_4","",newrec,new_rec);
            ...
            string selcuts_boosted_central_1 = "(N_Ak4 >=3 && Ele_pt > 55 && DeepttagN <= 1 && btagN >= 1 && M_tt > 450 &&chi2 < 30 && Ak4_add_pt > 100 && angle_theta_opt > 0.25*3.1459 && angle_theta_opt < 0.6*3.1459 && (Boost_top_E - Boost_antitop_E < -100) && !(leadgenjet_pt > 150 && subleadgenjet_pt > 50  && dressed_lep_pt > 55 && Gen_M_tt > 450 && h_parton_rec < 0))";
            string selcuts_boosted_central_2 = "(N_Ak4 >=3 && Ele_pt > 55 && DeepttagN <= 1 && btagN >= 1 && M_tt > 450 &&chi2 < 30 && Ak4_add_pt > 100 && angle_theta_opt > 0.25*3.1459 && angle_theta_opt < 0.6*3.1459 && (Boost_top_E - Boost_antitop_E > -100) && (Boost_top_E - Boost_antitop_E < 0)  && !(leadgenjet_pt > 150 && subleadgenjet_pt > 50  && dressed_lep_pt > 55 && Gen_M_tt > 450 && h_parton_rec < 0))";
            string selcuts_boosted_central_3 = "(N_Ak4 >=3 && Ele_pt > 55 && DeepttagN <= 1 && btagN >= 1 && M_tt > 450 &&chi2 < 30 && Ak4_add_pt > 100 && angle_theta_opt > 0.25*3.1459 && angle_theta_opt < 0.6*3.1459 && (Boost_top_E - Boost_antitop_E > 0) && (Boost_top_E - Boost_antitop_E < 100) && !(leadgenjet_pt > 150 && subleadgenjet_pt > 50  && dressed_lep_pt > 55 && Gen_M_tt > 450 && h_parton_rec < 0))";
            string selcuts_boosted_central_4 = "(N_Ak4 >=3 && Ele_pt > 55 && DeepttagN <= 1 && btagN >= 1 && M_tt > 450 &&chi2 < 30 && Ak4_add_pt > 100 && angle_theta_opt > 0.25*3.1459 && angle_theta_opt < 0.6*3.1459 && (Boost_top_E - Boost_antitop_E > 100) && !(leadgenjet_pt > 150 && subleadgenjet_pt > 50  && dressed_lep_pt > 55 && Gen_M_tt > 450 && h_parton_rec < 0))";
