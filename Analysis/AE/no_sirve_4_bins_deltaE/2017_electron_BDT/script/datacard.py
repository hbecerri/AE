...
#syst=['pileup','eleID','eleHLT','toptag_corr','toptag_uncorr','btag_HF_corr','btag_LF_corr','btag_HF_unc17','btag_LF_unc17']
...
datacard.write("shapes data_obs  *  /nfs/dust/cms/user/hugobg/UHH2_UL/CMSSW_10_6_28/src/UHH2/Analysis/AE/2017_electron_BDT/script/Input_undfolding_data.root $PROCESS\n")
datacard.write("shapes *         *  /nfs/dust/cms/user/hugobg/UHH2_UL/CMSSW_10_6_28/src/UHH2/Analysis/AE/2017_electron_BDT/script/Input_undfolding_data.root $PROCESS_nominal $PROCESS_$SYSTEMATIC\n")
