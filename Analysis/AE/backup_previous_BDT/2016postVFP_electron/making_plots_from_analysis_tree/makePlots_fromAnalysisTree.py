...
histograms = {
              ...
              "Ele_pt": ["p_{T} (e)", "Events", 25, [55,800]],
...
sample_names = ["TTTo2L2Nu_2016postVFP","TTToHadronic_2016postVFP","DYJetsToLL_M-50_HT_2016postVFP","ST_2016postVFP","WJetsToLNu_2016postVFP","TTToSemiLeptonic_2016postVFP"]
		...
		tree_MC[sample]=_file[sample].Get("AnalysisTree")
 	        ...
 	        tree_MC[sample].Draw("%s>>h2_%s(%i,%i,%f)"%(histName,sample,histograms[histName][2],histograms[histName][3][0],histograms[histName][3][1]),"eventweight*(N_Ak4 >=3 && Ele_pt > 55.0 && DeepttagN <= 1 && btagN >= 1 && M_tt > 450 &&chi2 < 30 && Ak4_add_pt > 100 && angle_theta_opt > 0.25*3.1459 && angle_theta_opt < 0.55*3.1459)")
                ...
                if(sample == "DYJetsToLL_M-50_HT_2016postVFP" or sample == "QCD_HT_2016postVFP" or sample == "ST_2016postVFP"):
                    ...
                    if(sample == "TTToSemiLeptonic_2016postVFP"):
...
dataHist.Draw("pe,x0")
histogr = stack.GetHists()  # Returns a TList of histograms
for i, hist in enumerate(histogr):
        first_bin_content = hist.SetBinContent(1,hist.GetBinContent(1)*1.1)
