...
sample_names = ["TTTo2L2Nu_2016postVFP","TTToHadronic_2016postVFP","TTToHadronic_2016postVFP","TTToHadronic_2016postVFP","Diboson_2016postVFP","QCD_HT_2016postVFP","DYJetsToLL_M-50_HT_2016postVFP","ST_2016postVFP","WJetsToLNu_2016postVFP","TTToSemiLeptonic_2016postVFP"]
...
for sample in sample_names:
		...
		tree_MC[sample]=_file[sample].Get("AnalysisTree")
 	        ...
 	        tree_MC[sample].Draw("%s>>h2_%s(%i,%i,%f)"%(histName,sample,histograms[histName][2],histograms[histName][3][0],histograms[histName][3][1]),"eventweight*(N_Ak4 >=3 && Mu_pt > 55.0 && DeepttagN <= 1 && btagN >= 1 && M_tt > 450 &&chi2 < 30 && Ak4_add_pt > 100 && angle_theta_opt > 0.25*3.1459 && angle_theta_opt < 0.55*3.1459)")
                ...
                if(sample == "DYJetsToLL_M-50_HT_2016postVFP" or sample == "QCD_HT_2016postVFP" or sample == "ST_2016postVFP" or sample == "Diboson_2016postVFP"):
...
_file_syst = TFile("/data/dust/user/hugobg/UHH2_UL/CMSSW_10_6_28/src/UHH2/Analysis/AE/backup_previous_BDT/2016_muon/making_plots_from_analysis_tree/Mu_pt/Input_undfolding_data_%s.root"%(argv[1]),"read")
