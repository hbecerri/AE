...
//array for variable 
    ...
    Float_t new_rec[]  = {500,750,1000,1250,1500,1750,2000,2250,2500,2750,3000,3250,3500,3750,4000,4250,4500,4750,5000};  
...
//--------Unfold----------??
       ...
       string selcuts_boosted_central_1 = "(chi2 > 30 && N_Ak8 > 1 && N_Ak4 < 4 && M_tt > 500)";
       treereco_data->Project("Back_1","M_tt",Form("%s",selcuts_boosted_central_1.c_str()));
...
//        string systs[] = {"1"};
        ...
        for(const string &syst : systs){
           ...
           treereco_ttbar_semi->Project("Migration_Matrix_1","Gen_Boost_top_E - Gen_Boost_antitop_E:M_tt",Form("%s*eventweight*%s",selcuts_boosted_central_1.c_str(),syst.c_str()));
        ...
        for(const string &syst : systs){
            ...
            treereco_ttbar_semi->Project("Back_1","M_tt",Form("%s*eventweight*%s",selcuts_boosted_central_1.c_str(),syst.c_str()));
