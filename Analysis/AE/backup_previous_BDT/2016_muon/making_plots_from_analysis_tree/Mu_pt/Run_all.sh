...
#"Mu_pt" "Mu_eta" "Ak4_j1_pt" "Ak4_j2_pt" "Ak4_j1_eta" "Ak4_j2_eta" "M_tt" "N_Ak4" "btagN" "chi2" "MET_pt"
 
#root -l -b -q 'all_unfolding_data.C(25,55,550,"Mu_pt")'
#mv Input_undfolding_data_all.root Input_undfolding_data_Mu_pt.root

#root -l -b -q 'all_unfolding_data.C(25,-2.4,2.4,"Mu_eta")'
#mv Input_undfolding_data_all.root Input_undfolding_data_Mu_eta.root
