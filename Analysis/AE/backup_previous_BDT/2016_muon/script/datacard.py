...
syst=['hdamp','pileup','muISO','muID','muHLT','toptag_corr','toptag_uncorr','FSR', 'ISR', 'MuR', 'MuF','MuR_MuF','btag_HF_corr','btag_LF_corr','btag_HF_unc16','btag_LF_unc16','BBEC1_2016','EC2_2016','RelativeSample_2016','Absolute_2016','HF','EC2','Absolute','RelativeBal']
...
datacard.write("shapes data_obs  *  /nfs/dust/cms/user/hugobg/UHH2_UL/CMSSW_10_6_28/src/UHH2/Analysis/AE/2016_muon/script/Input_undfolding_data_all_2.root $PROCESS\n")
datacard.write("shapes *         *  /nfs/dust/cms/user/hugobg/UHH2_UL/CMSSW_10_6_28/src/UHH2/Analysis/AE/2016_muon/script/Input_undfolding_data_all_2.root $PROCESS_nominal $PROCESS_$SYSTEMATIC\n")
