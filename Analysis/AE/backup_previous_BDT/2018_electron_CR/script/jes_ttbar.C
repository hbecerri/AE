...
//--------Unfold----------??
       ...
       for(const string &syst : systs){
            ...
            chreco_ttbar_semi->Add(Form("/nfs/dust/cms/user/hugobg/analysis/electron/uhh2.AnalysisModuleRunner.MC.TTToSemiLeptonic_2018.root/AnalysisTree",syst.c_str()));
       ...
       for(const string &syst : systs){
            ...
            chreco_ttbar_semi1->Add(Form("/nfs/dust/cms/user/hugobg/analysis/electron/uhh2.AnalysisModuleRunner.MC.TTToSemiLeptonic_2018%sup.root/AnalysisTree",syst.c_str()));
            TTree *treereco_ttbar_semi1 = (TTree*) chreco_ttbar_semi1;
 
            TChain *chreco_ttbar_semi2 = new TChain("AnalysisTree","");
            chreco_ttbar_semi2->Add(Form("/nfs/dust/cms/user/hugobg/analysis/electron/uhh2.AnalysisModuleRunner.MC.TTToSemiLeptonic_2018%sdown.root/AnalysisTree",syst.c_str()));
