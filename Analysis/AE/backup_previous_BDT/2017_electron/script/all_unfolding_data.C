...
string texts[]={"DATA","TTToSemiLeptonic","WJetsToLNu","ST","DYJetsToLL_M-50_HT","QCD_HT","Diboson","TTTo2L2Nu"};
...
//----obetener_toda_la_informacion_de_entrada--------??
    ...
    //if(text == "TTToHadronic") chreco_ttbar_semi->Add(Form("/nfs/dust/cms/user/hugobg/analysis/electron/workdir_Analysis_UL17_electron/uhh2.AnalysisModuleRunner.MC.%s*.root/AnalysisTree",text.c_str()));
...
//--------Unfold----------??
       ...
       string selcuts_boosted_central_1 = "(N_Ak4 >=3 && Ele_pt > 55 && DeepttagN <= 1 && btagN >= 1 && M_tt > 450 &&chi2 < 30 && Ak4_add_pt > 100 && angle_theta_opt > 0.25*3.1459 && angle_theta_opt < 0.55*3.1459)";
...
//        string systs[] = {"1"};
        ...
        for(const string &syst : systs){
           ...
           string selcuts_boosted_central_1 = "(MET_pt > 80 && N_Ak4 >=3 && Ele_pt > 55 && DeepttagN <= 1 && btagN >= 1 && M_tt > 450 &&chi2 < 30 && Ak4_add_pt > 100 && angle_theta_opt > 0.25*3.1459 && angle_theta_opt < 0.55*3.1459 && leadgenjet_pt > 150 && subleadgenjet_pt > 50  && dressed_lep_pt > 55 && Gen_M_tt > 450 && h_parton_rec < 0 )";
            ...
            if(syst == "1"){
                ...
                latex.DrawLatex(-2000,20005.5,"CMS preliminary");
                TLatex latex2;
                latex2.SetTextSize(0.045);
                latex2.SetTextAlign(11);  //align at top
                latex2.DrawLatex(12000,20005.5,"58.8 fb^{-1} (13 TeV)");
                c1->Print("Migration_Matrix_Mapp_2017_electron.pdf");
             ...
             for(int a=1;a<=binnum_gen;a++){
                ...
                latex4.DrawLatex(12000,1.02,"41.5 fb^{-1} (13 TeV)");

                cc->Print("PS_2017_electron.pdf");
