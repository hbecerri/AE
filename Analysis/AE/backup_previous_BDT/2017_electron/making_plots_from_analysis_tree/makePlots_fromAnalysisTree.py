...
sample_names = ["DYJetsToLL_M-50_HT_2017","ST_2017","WJetsToLNu_2017","TTTo2L2Nu_2017","TTToHadronic_2017","TTToSemiLeptonic_2017"]
 	        ...
 	        tree_MC[sample].Draw("%s>>h2_%s(%i,%i,%f)"%(histName,sample,histograms[histName][2],histograms[histName][3][0],histograms[histName][3][1]),"eventweight*(N_Ak4 >=3 && Ele_pt > 55.0 && DeepttagN <= 1 && btagN >= 1 && M_tt > 450 &&chi2 < 30 && Ak4_add_pt > 100 && angle_theta_opt > 0.25*3.1459 && angle_theta_opt < 0.55*3.1459)")
                ...
                if(sample == "DYJetsToLL_M-50_HT_2017" or sample == "QCD_HT_2017" or sample == "ST_2017"):
                    ...
                    if(sample == "WJetsToLNu_2017"):
                        ...
                        hist1_[sample].SetFillColor(stackList[sample][0])
                        hist1_[sample].SetLineColor(stackList[sample][0])
                    if("TTTo2" in sample or "TTToH" in sample):
...
_file_syst = TFile("/data/dust/user/hugobg/UHH2_UL/CMSSW_10_6_28/src/UHH2/Analysis/AE/backup_previous_BDT/2017_electron/making_plots_from_analysis_tree/Mu_pt/Input_undfolding_data_%s.root"%(argv[1]),"read")
