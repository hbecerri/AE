...
for samp in samplelist:
    for syst in systematic_direction:
        ...
        latex2.DrawLatex(1000,a*1.52,"58.80 fb^{-1} (13 TeV)")
        ...
        #if('post' in argv[1]):  latex2.DrawLatex(1000,a*1.52,"16.81 fb^{-1} (13 TeV)")
        ...
        #systvarhistRatio[samp+syst+'__plus__ratio'].GetXaxis().SetTitleSize(0.6)
        systvarhistRatio[samp+syst+'__plus__ratio'].GetXaxis().SetTitle("#Delta E")
        ...
        canvas_Bkg[samp+syst].SaveAs(samp+syst+'_2018muon.pdf')
