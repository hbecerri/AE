...
text2workspace.py muon_2018_750_900.txt -o muon_2018_750_900.root  -P HiggsAnalysis.CombinedLimit.PhysicsModel:multiSignalModel -m 125 --PO map='.*/TTToSemiLeptonic_1:rneg[1,0,20]' --PO map='.*/TTToSemiLeptonic_2:rpos=expr;;rpos("8006.7598/8052.5256*@0*(100+@1)/(100-@1)",rneg,AE[-0.28,-20,20])' --PO verbose
