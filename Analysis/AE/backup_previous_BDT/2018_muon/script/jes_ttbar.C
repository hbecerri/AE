...
//--------Unfold----------??
       ...
       for(const string &syst : systs){
            ...
            string sys = "";
            if(syst == "_JEREC1") sys = "_BBEC1_2018";
            if(syst == "_JEREC2") sys = "_EC2_2018";
            if(syst == "_RelativeSample") sys = "_RelativeSample_2018";
            if(syst == "_RelativeStatFSR") sys = "_Absolute_2018";
