...
//--------Unfold----------??
       ...
       string selcuts_boosted_central_1 = "(N_Ak4 >=3 && Mu_pt > 55 && DeepttagN <= 1 && btagN >= 1 && M_tt > 450 && chi2 < 30 && Ak4_add_pt > 100 && angle_theta_opt > 0 && angle_theta_opt < 3.1416)";
...
//        string systs[] = {"1"};
        ...
        for(const string &syst : systs){
            ...
            string selcuts_boosted_central_1 = "(N_Ak4 >=3 && Mu_pt > 55 && DeepttagN <= 1 && btagN >= 1 && M_tt > 450 && chi2 < 30 && Ak4_add_pt > 100 && angle_theta_opt > 0 && angle_theta_opt < 3.1416 && leadgenjet_pt > 150 && subleadgenjet_pt > 50  && dressed_lep_pt > 55 && Gen_M_tt > 450 && h_parton_rec < 0     )";
