...
datacard.write("shapes data_obs  *  /nfs/dust/cms/user/hugobg/UHH2_UL/CMSSW_10_6_28/src/UHH2/Analysis/AE/theta/2016preVFP_muon/2016preVFP_muon_700_900/script/Input_undfolding_data_.root $PROCESS\n")
datacard.write("shapes *         *  /nfs/dust/cms/user/hugobg/UHH2_UL/CMSSW_10_6_28/src/UHH2/Analysis/AE/theta/2016preVFP_muon/2016preVFP_muon_700_900/script/Input_undfolding_data_.root $PROCESS_nominal $PROCESS_$SYSTEMATIC\n")
