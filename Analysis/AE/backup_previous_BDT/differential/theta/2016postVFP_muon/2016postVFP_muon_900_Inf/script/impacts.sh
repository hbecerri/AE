...
text2workspace.py muon_2016postVFP_900_Inf.txt -o muon_2016postVFP_900_Inf.root  -P HiggsAnalysis.CombinedLimit.PhysicsModel:multiSignalModel -m 125 --PO map='.*/TTToSemiLeptonic_1:r_1[1,0,20]' --PO map='.*/TTToSemiLeptonic_2:r_2[1,0,20]' --PO verbose

#text2workspace.py muon_2016postVFP_750_900.txt -o muon_2016postVFP_750_900.root  -P HiggsAnalysis.CombinedLimit.PhysicsModel:multiSignalModel -m 125 --PO map='.*/TTToSemiLeptonic_1:rneg[1,0,20]' --PO map='.*/TTToSemiLeptonic_2:rpos=expr;;rpos("10839/10866*@0*(100+@1)/(100-@1)",rneg,AE[0.01,-5,5])' --PO verbose
...
export WORKSPACE=muon_2016postVFP_900_Inf.root
export VERBOSITY=0
