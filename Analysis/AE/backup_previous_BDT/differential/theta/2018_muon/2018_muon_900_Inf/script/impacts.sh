...
text2workspace.py muon_2018_900_Inf.txt -o muon_2018_900_Inf.root  -P HiggsAnalysis.CombinedLimit.PhysicsModel:multiSignalModel -m 125 --PO map='.*/TTToSemiLeptonic_1:r_1[1,0,20]' --PO map='.*/TTToSemiLeptonic_2:r_2[1,0,20]' --PO verbose
...
export WORKSPACE=muon_2018_900_Inf.root
export VERBOSITY=0
