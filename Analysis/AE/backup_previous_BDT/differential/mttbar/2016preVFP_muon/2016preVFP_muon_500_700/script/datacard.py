...
N_reco_bins = 0
datacard=open("muon_2016_500_700.txt","w")
...
datacard.write("shapes data_obs  *  /nfs/dust/cms/user/hugobg/UHH2_UL/CMSSW_10_6_28/src/UHH2/Analysis/AE/mttbar/2016preVFP_muon/2016preVFP_muon_500_700/script/Input_undfolding_data_.root $PROCESS\n")
datacard.write("shapes *         *  /nfs/dust/cms/user/hugobg/UHH2_UL/CMSSW_10_6_28/src/UHH2/Analysis/AE/mttbar/2016preVFP_muon/2016preVFP_muon_500_700/script/Input_undfolding_data_.root $PROCESS_nominal $PROCESS_$SYSTEMATIC\n")

datacard.write("----------------\n")

datacard.write("bin muon_2016_500_700")
datacard.write("\n")
...
for ireco in range(1,len(proc)+1):
    datacard.write("muon_2016_500_700 ")
datacard.write("\n")
