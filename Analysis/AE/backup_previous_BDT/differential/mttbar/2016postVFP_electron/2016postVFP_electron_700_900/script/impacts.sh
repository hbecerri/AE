...
text2workspace.py electron_2016postVFP_700_900.txt -o electron_2016postVFP_700_900.root  -P HiggsAnalysis.CombinedLimit.PhysicsModel:multiSignalModel -m 125 --PO map='.*/TTToSemiLeptonic_1:r_1[1,0,20]' --PO map='.*/TTToSemiLeptonic_2:r_2[1,0,20]' --PO verbose

#text2workspace.py electron_2016postVFP_700_900.txt -o electron_2016postVFP_700_900.root  -P HiggsAnalysis.CombinedLimit.PhysicsModel:multiSignalModel -m 125 --PO map='.*/TTToSemiLeptonic_1:rneg[1,0,20]' --PO map='.*/TTToSemiLeptonic_2:rpos=expr;;rpos("8129/8137*@0*(100+@1)/(100-@1)",rneg,AE[-0.04,-7,7])' --PO verbose
...
export WORKSPACE=electron_2016postVFP_700_900.root
export VERBOSITY=0
