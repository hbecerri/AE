...
syst=['hdamp','L1Prefiring16','top_pt_rew','pileup','eleID','eleHLT','toptag_corr','toptag_uncorr','FSR', 'ISR', 'MuR', 'MuF','btag_HF_corr','btag_LF_corr','btag_HF_unc16','btag_LF_unc16','PDF1','PDF2']
...
N_reco_bins = 0
datacard=open("electron_2016_700_900.txt","w")
...
datacard.write("shapes data_obs  *  /nfs/dust/cms/user/hugobg/UHH2_UL/CMSSW_10_6_28/src/UHH2/Analysis/AE/mttbar/2016preVFP_electron/2016preVFP_electron_700_900/script/Input_undfolding_data_.root $PROCESS\n")
datacard.write("shapes *         *  /nfs/dust/cms/user/hugobg/UHH2_UL/CMSSW_10_6_28/src/UHH2/Analysis/AE/mttbar/2016preVFP_electron/2016preVFP_electron_700_900/script/Input_undfolding_data_.root $PROCESS_nominal $PROCESS_$SYSTEMATIC\n")

datacard.write("----------------\n")

datacard.write("bin electron_2016_700_900")
datacard.write("\n")
...
for ireco in range(1,len(proc)+1):
    datacard.write("electron_2016_700_900 ")
datacard.write("\n")
