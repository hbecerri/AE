...
fin = TFile('/nfs/dust/cms/user/hugobg/UHH2_UL/CMSSW_10_6_28/src/UHH2/Analysis/AE/mttbar/%s/script/Input_undfolding_data_.root'%(argv[1]), 'open')
nominalhist = {}
nominalhistDraw = {}
systvarhist = {}
systvarhistDraw = {}
...
for samp in samplelist:
    for syst in systematic_direction:
        ...
        if('2018' in argv[1]):  latex2.DrawLatex(1000,a*1.52,"58.80 fb^{-1} (13 TeV)")
