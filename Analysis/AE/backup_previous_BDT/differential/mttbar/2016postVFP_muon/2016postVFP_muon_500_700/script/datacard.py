...
syst=['hdamp','L1Prefiring16','top_pt_rew','pileup','muISO','muID','muHLT','toptag_corr','toptag_uncorr','FSR', 'ISR', 'MuR', 'MuF','btag_HF_corr','btag_LF_corr','btag_HF_unc16','btag_LF_unc16','PDF1']#,'PDF2','PDF3','PDF4','PDF5','PDF6','PDF7','PDF8','PDF9','PDF10','PDF11','PDF12','PDF13','PDF14','PDF15','PDF16','PDF17','PDF16','PDF19','PDF20','PDF21','PDF22','PDF23','PDF24','PDF25','PDF26','PDF27','PDF28','PDF29','PDF30','PDF31','PDF32','PDF33','PDF34','PDF35','PDF36','PDF37','PDF38','PDF39','PDF40','PDF41','PDF42','PDF43','PDF44','PDF45','PDF46','PDF47','PDF48','PDF49','PDF50','PDF51','PDF52','PDF53','PDF54','PDF55','PDF56','PDF57','PDF58','PDF59','PDF60','PDF61','PDF62','PDF63','PDF64','PDF65','PDF66','PDF67','PDF68','PDF69','PDF70','PDF71','PDF72','PDF73','PDF74','PDF75','PDF76','PDF77','PDF78','PDF79','PDF80','PDF81','PDF82','PDF83','PDF84','PDF85','PDF86','PDF87','PDF88','PDF89','PDF90','PDF91','PDF92','PDF93','PDF94','PDF95','PDF96','PDF97','PDF98','PDF99']
...
N_reco_bins = 0
datacard=open("muon_2016postVFP_500_700.txt","w")
...
datacard.write("shapes data_obs  *  /nfs/dust/cms/user/hugobg/UHH2_UL/CMSSW_10_6_28/src/UHH2/Analysis/AE/mttbar/2016postVFP_muon/2016postVFP_muon_500_700/script/Input_undfolding_data_.root $PROCESS\n")
datacard.write("shapes *         *  /nfs/dust/cms/user/hugobg/UHH2_UL/CMSSW_10_6_28/src/UHH2/Analysis/AE/mttbar/2016postVFP_muon/2016postVFP_muon_500_700/script/Input_undfolding_data_.root $PROCESS_nominal $PROCESS_$SYSTEMATIC\n")

datacard.write("----------------\n")

datacard.write("bin muon_2016postVFP_500_700")
datacard.write("\n")
...
for ireco in range(1,len(proc)+1):
    datacard.write("muon_2016postVFP_500_700 ")
datacard.write("\n")
