...
N_reco_bins = 0
datacard=open("electron_2018_700_900.txt","w")
...
datacard.write("shapes data_obs  *  /nfs/dust/cms/user/hugobg/UHH2_UL/CMSSW_10_6_28/src/UHH2/Analysis/AE/mttbar/2018_electron/2018_electron_700_900/script/Input_undfolding_data_.root $PROCESS\n")
datacard.write("shapes *         *  /nfs/dust/cms/user/hugobg/UHH2_UL/CMSSW_10_6_28/src/UHH2/Analysis/AE/mttbar/2018_electron/2018_electron_700_900/script/Input_undfolding_data_.root $PROCESS_nominal $PROCESS_$SYSTEMATIC\n")

datacard.write("----------------\n")

datacard.write("bin electron_2018_700_900")
datacard.write("\n")
...
for ireco in range(1,len(proc)+1):
    datacard.write("electron_2018_700_900 ")
datacard.write("\n")
