...
latex.DrawLatex(0.02,20**(1.66*log10(maxVal) - 0.5*log10(minVal)),"CMS #font[12]{preliminary}");
latex.DrawLatex(19.0,20**(1.67*log10(maxVal) - 0.5*log10(minVal)),"138 fb^{-1} (13 TeV)");

latex.SetTextSize(0.03)
latex.DrawLatex(0.5,50000,"m_{t#bar{t}} #in [500,700]");
latex.DrawLatex(2.5,50000,"m_{t#bar{t}} #in [700,900]");
latex.DrawLatex(4.5,50000,"m_{t#bar{t}} #in [900,Inf]");
