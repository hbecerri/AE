...
syst=['hdamp','L1Prefiring16','top_pt_rew','pileup','muISO','muID','muHLT','toptag_corr','toptag_uncorr','FSR', 'ISR', 'MuR', 'MuF','MuR_MuF','btag_HF_corr','btag_LF_corr','btag_HF_unc16','btag_LF_unc16','JEREC1','JEREC2','PtEC1','PtEC2','RelativeSample','RelativeStatEC','RelativeStatFSR','TimePtEta','PDF1','PDF2']
...
N_reco_bins = 0
datacard=open("muon_CR_2016postVFP_750_900.txt","w")
...
datacard.write("shapes data_obs  *  /nfs/dust/cms/user/hugobg/UHH2_UL/CMSSW_10_6_28/src/UHH2/Analysis/AE/2016postVFP_muon_CR/script/Input_undfolding_data_.root $PROCESS\n")
datacard.write("shapes *         *  /nfs/dust/cms/user/hugobg/UHH2_UL/CMSSW_10_6_28/src/UHH2/Analysis/AE/2016postVFP_muon_CR/script/Input_undfolding_data_.root $PROCESS_nominal $PROCESS_$SYSTEMATIC\n")

datacard.write("----------------\n")

datacard.write("bin muon_CR_2016postVFP_750_900")
datacard.write("\n")
...
for ireco in range(1,len(proc)+1):
    datacard.write("muon_CR_2016postVFP_750_900 ")
datacard.write("\n")
