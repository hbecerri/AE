...
syst=['hdamp','top_pt_rew','pileup','eleID','eleHLT','toptag_corr','toptag_uncorr','FSR', 'ISR', 'MuR', 'MuF','MuR_MuF','btag_HF_corr','btag_LF_corr','btag_HF_unc18','btag_LF_unc18','BBEC1_2018','EC2_2018','RelativeSample_2018','Absolute_2018','HF','EC2','Absolute','RelativeBal','PDF1','PDF2']
...
datacard.write("shapes data_obs  *  /nfs/dust/cms/user/hugobg/UHH2_UL/CMSSW_10_6_28/src/UHH2/Analysis/AE/2018_electron/script/Input_undfolding_data_all_2.root $PROCESS\n")
datacard.write("shapes *         *  /nfs/dust/cms/user/hugobg/UHH2_UL/CMSSW_10_6_28/src/UHH2/Analysis/AE/2018_electron/script/Input_undfolding_data_all_2.root $PROCESS_nominal $PROCESS_$SYSTEMATIC\n")
