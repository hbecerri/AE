...
//--------Unfold----------??
       ...
       for(const string &syst : systs){
            ...
            string selcuts_boosted_central_1 = "(Ele_pt > 55 && DeepttagN <= 1 && btagN >= 1 && M_tt > 500 && chi2 < 30 && Ak4_add_pt > 100)";
       ...
       for(const string &syst : systs){
            ...
            string selcuts_boosted_central_2 = "(Ele_pt > 55 && DeepttagN <= 1 && btagN >= 1 && M_tt > 500 && chi2 < 30 && Ak4_add_pt > 100)";
