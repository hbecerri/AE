...
//----obetener_toda_la_informacion_de_entrada--------??
    ...
    chreco_ttbar_semi->Add(Form("/data/dust/user/hugobg/analysis/electron/uhh2.AnalysisModuleRunner.MC.%s_2016preVFP.root/AnalysisTree",text.c_str()));
...
//--------Unfold----------??
       ...
       chreco_data->Add("/data/dust/user/hugobg/analysis/electron/uhh2.AnalysisModuleRunner.DATA.DATA_SingleMuon_Run2016preVFP.root/AnalysisTree");
