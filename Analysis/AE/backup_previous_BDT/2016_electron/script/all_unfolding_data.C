...
//        string systs[] = {"1"};
        ...
        for(const string &syst : systs){
           ...
           string selcuts_boosted_central_1 = "(MET_pt > 80 && N_Ak4 >=3 && Ele_pt > 55 && DeepttagN <= 1 && btagN >= 1 && M_tt > 450 &&chi2 < 30 && Ak4_add_pt > 100 && angle_theta_opt > 0.25*3.1459 && angle_theta_opt < 0.55*3.1459 && leadgenjet_pt > 150 && subleadgenjet_pt > 55  && dressed_lep_pt > 55 && Gen_M_tt > 450 && h_parton_rec < 0 )"; 
            ...
            if(syst == "1"){
                ...
                c1->Print("Migration_Matrix_Mapp_2016_electron.pdf");
             ...
             for(int a=1;a<=binnum_gen;a++){
                ...
                latex3.DrawLatex(-20009.0,1.02,"CMS preliminary");

                TLatex latex4;
                latex4.SetTextSize(0.045);
                latex4.SetTextAlign(11);
                latex4.DrawLatex(12000,1.02,"19.52 fb^{-1} (13 TeV)");

                cc->Print("PS_2016_electron.pdf");
