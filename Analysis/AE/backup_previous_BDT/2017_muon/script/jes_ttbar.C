...
//--------Unfold----------??
       ...
       for(const string &syst : systs){
            ...
            chreco_ttbar_semi->Add(Form("/nfs/dust/cms/user/hugobg/analysis/muon/uhh2.AnalysisModuleRunner.MC.TTToSemiLeptonic_2017.root/AnalysisTree",syst.c_str()));
            ...
            string selcuts_boosted_central_1 = Form("(N_Ak4 >=3 && Mu_pt > 55 && DeepttagN <= 1 && btagN >= 1 && M_tt > 500 && chi2 < 30 && Ak4_add_pt > 100 && angle_theta_opt > 0.25*3.1459 && angle_theta_opt < 0.60*3.1459 && slimmedGenJets.m_pt[0] > 150 && slimmedGenJets.m_pt[1] > 100 && slimmedMETs_GenMET.m_pt[0] > 50 && %s > 500)", Mttbar_gen.c_str());
       ...
       for(const string &syst : systs){
            ...
            chreco_ttbar_semi1->Add(Form("/nfs/dust/cms/user/hugobg/analysis/muon/uhh2.AnalysisModuleRunner.MC.TTToSemiLeptonic_2017%sup.root/AnalysisTree",syst.c_str()));
            TTree *treereco_ttbar_semi1 = (TTree*) chreco_ttbar_semi1;
 
            TChain *chreco_ttbar_semi2 = new TChain("AnalysisTree","");
            chreco_ttbar_semi2->Add(Form("/nfs/dust/cms/user/hugobg/analysis/muon/uhh2.AnalysisModuleRunner.MC.TTToSemiLeptonic_2017%sdown.root/AnalysisTree",syst.c_str()));
            ...
            string selcuts_boosted_central_2 = Form("(N_Ak4 >=3 && Mu_pt > 55 && DeepttagN <= 1 && btagN >= 1 && M_tt > 500 && chi2 < 30 && Ak4_add_pt > 100 && angle_theta_opt > 0.25*3.1459 && angle_theta_opt < 0.60*3.1459 && slimmedGenJets.m_pt[0] > 150 && slimmedGenJets.m_pt[1] > 100 && slimmedMETs_GenMET.m_pt[0] > 50 && %s > 500)", Mttbar_gen.c_str());
            ...
            string sys = "";
            if(syst == "_JEREC1") sys = "_BBEC1_2017";
            if(syst == "_JEREC2") sys = "_EC2_2017";
            if(syst == "_RelativeSample") sys = "_RelativeSample_2017";
            if(syst == "_RelativeStatFSR") sys = "_Absolute_2017";
