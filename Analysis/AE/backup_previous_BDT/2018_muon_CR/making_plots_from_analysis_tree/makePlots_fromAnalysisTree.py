...
histograms = {
              ...
              "Mu_pt": ["p_{T} (#mu)", "Events", 25, [55,800]],
              "N_Ak4": ["N_{jets}", "Events", 8, [2,10]],
              "antitop_m": ["M_tt", "Events", 40, [100, 500]],
              "top_m": ["M_tt", "Events", 40, [100, 500]],
              "chi2":["chi2","Events", 5,[0,30]]
} 

sample_names = ["Diboson_2018","QCD_HT_2018","DYJetsToLL_M-50_HT_2018","ST_2018","WJetsToLNu_2018","TTTo2L2Nu_2018","TTToHadronic_2018","TTToSemiLeptonic_2018"]
...
for sample in sample_names:
		...
		tree_MC[sample]=_file[sample].Get("AnalysisTree")
 	        ...
 	        tree_MC[sample].Draw("%s>>h2_%s(%i,%i,%f)"%(histName,sample,histograms[histName][2],histograms[histName][3][0],histograms[histName][3][1]),"eventweight*(N_Ak4 < 4 && Mu_pt > 55 && DeepttagN == 0 && btagN == 1 && M_tt > 1000 && chi2 < 50  && (angle_theta_opt < 0.25*3.1459 || angle_theta_opt > 0.55*3.1459))")
...
tree.Draw("%s>>dat_hist(%i,%i,%f)"%(histName,histograms[histName][2],histograms[histName][3][0],histograms[histName][3][1]),"1*(N_Ak4 < 4 && Mu_pt > 55 && DeepttagN == 0 && btagN == 1 && M_tt > 1000 && chi2 < 50  && (angle_theta_opt < 0.25*3.1459 || angle_theta_opt > 0.55*3.1459))")
