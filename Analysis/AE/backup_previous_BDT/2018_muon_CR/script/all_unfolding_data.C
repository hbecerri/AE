...
//array for variable 
    ...
    int len = 12, len_rec = 12;
    Float_t bins_gen[] = {50,100,150,200,250,300,350,400,450,500};
    Float_t new_rec[]  = {50,100,150,200,250,300,350,400,450,500};
...
//--------Unfold----------??
       ...
       string selcuts_boosted_central_1 = "(N_Ak4 < 4 && Mu_pt > 55 && DeepttagN == 0 && btagN == 1 && M_tt > 1000 && chi2 < 50  && (angle_theta_opt < 0.25*3.1459 || angle_theta_opt > 0.55*3.1459))";
       treereco_data->Project("Back_1","Mu_pt",Form("%s",selcuts_boosted_central_1.c_str()));
...
//        string systs[] = {"1"};
        ...
        for(const string &syst : systs){
            ...
            string selcuts_boosted_central_1 = "(N_Ak4 < 4 && Mu_pt > 55 && DeepttagN == 0 && btagN == 1 && M_tt > 1000 && chi2 < 50  && (angle_theta_opt < 0.25*3.1459 || angle_theta_opt > 0.55*3.1459) && leadgenjet_pt > 150 && subleadgenjet_pt > 50  && dressed_lep_pt > 55 && Gen_M_tt > 450 && h_parton_rec < 0)";
            treereco_ttbar_semi->Project("Migration_Matrix_1","Gen_Boost_top_E - Gen_Boost_antitop_E:Mu_pt",Form("%s*eventweight*%s",selcuts_boosted_central_1.c_str(),syst.c_str()));
            ...
            if(syst == "1"){
                ...
                c1->Print("Migration_Matrix_Mapp_2018_muon.pdf");
             ...
             for(int a=1;a<=binnum_gen;a++){
                ...
                latex4.DrawLatex(12000,1.02,"58.8 fb^{-1} (13 TeV)");

                cc->Print("PS_2018_muon.pdf");
        ...
        for(const string &syst : systs){
            ...
            TH1F *Back_1 = new TH1F("Back_1","",newrec,new_rec);
            string selcuts_boosted_central_1 = "(N_Ak4 < 4 && Mu_pt > 55 && DeepttagN == 0 && btagN == 1 && M_tt > 1000 && chi2 < 50  && (angle_theta_opt < 0.25*3.1459 || angle_theta_opt > 0.55*3.1459) && !(leadgenjet_pt > 150 && subleadgenjet_pt > 50  && dressed_lep_pt > 55 && Gen_M_tt > 450 && h_parton_rec < 0))";
            treereco_ttbar_semi->Project("Back_1","Mu_pt",Form("%s*eventweight*%s",selcuts_boosted_central_1.c_str(),syst.c_str()));
