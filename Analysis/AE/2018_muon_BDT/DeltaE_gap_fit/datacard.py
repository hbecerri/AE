...
datacard.write("shapes data_obs  *  /nfs/dust/cms/user/hugobg/UHH2_UL/CMSSW_10_6_28/src/UHH2/Analysis/AE/2018_muon_BDT/DeltaE_gap_fit/Input_undfolding_data_all.root $PROCESS\n")
datacard.write("shapes *         *  /nfs/dust/cms/user/hugobg/UHH2_UL/CMSSW_10_6_28/src/UHH2/Analysis/AE/2018_muon_BDT/DeltaE_gap_fit/Input_undfolding_data_all.root $PROCESS_nominal $PROCESS_$SYSTEMATIC\n")
