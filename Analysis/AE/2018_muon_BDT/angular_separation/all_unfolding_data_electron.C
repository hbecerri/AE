...
void all_unfolding_data_electron(string var_name = "", string var_gen = "", string region = "", string year = "2018")
{
...
//----obetener_toda_la_informacion_de_entrada--------??
    ...
    chreco_ttbar_semi->Add("/nfs/dust/cms/user/hugobg/analysis/electron/uhh2.AnalysisModuleRunner.MC.TTToSemiLeptonic_2018.root/AnalysisTree");
...
//--------Unfold----------??
    ...
    if(text == "Ttbar_in"){
         ...
         for(const string &syst : systs){
            ...
            string selcuts_boosted_central_1 = "(N_Ak4 >=3 && Ele_pt > 55.0 && DeepttagN <= 1 && btagN >= 1 && M_tt > 450 &&chi2 < 30 && Ak4_add_pt > 100 && angle_theta_opt > 0.25*3.1459 && angle_theta_opt < 0.6*3.1459 && leadgenjet_pt > 150 && subleadgenjet_pt > 50  && dressed_lep_pt > 55 && Gen_M_tt > 450 && h_parton_rec < 0)";
