...
#text2workspace.py  muon_2018_750_900.txt -o muon_2018_750_900.root  -P HiggsAnalysis.CombinedLimit.PhysicsModel:multiSignalModel -m 125 --PO map='.*/Ttbar_in_1:r_1[1,0,20]' --PO map='.*/Ttbar_in_2:r_2[1,0,20]' --PO verbose

text2workspace.py muon_2018_750_900.txt -o muon_2018_750_900.root -P HiggsAnalysis.CombinedLimit.PhysicsModel:multiSignalModel -m 125 --PO map='.*/Ttbar_in_1:rneg[1,0,20]' --PO map='.*/Ttbar_in_2:r_pos=expr;;r_pos("34480.0597/34345.6129*@0*(100+@1)/(100-@1)",rneg,AE[-0.19,-20,20])' --PO verbose
...
export SetParameters="rgx{r.+}=1,AE=-0.49"
export SetParametersExplicit="rneg=1,AE=-0.49"
