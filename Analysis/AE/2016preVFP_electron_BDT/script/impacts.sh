...
text2workspace.py  electron_2016preVFP_750_900.txt -o electron_2016preVFP_750_900.root  -P HiggsAnalysis.CombinedLimit.PhysicsModel:multiSignalModel -m 125 --PO map='.*/Ttbar_in_1:r_1[1,0,20]' --PO map='.*/Ttbar_in_2:r_2[1,0,20]' --PO verbose
...
export WORKSPACE=electron_2016preVFP_750_900.root
export VERBOSITY=0
