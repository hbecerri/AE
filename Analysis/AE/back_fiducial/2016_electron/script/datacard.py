...
syst=['hdamp','L1Prefiring16','top_pt_rew','pileup','eleID','eleHLT','toptag_corr','toptag_uncorr','FSR', 'ISR', 'MuR', 'MuF', 'MuR_MuF','btag_HF_corr','btag_LF_corr','btag_HF_unc16','btag_LF_unc16','JEREC1','JEREC2','PtEC1','PtEC2','RelativeSample','RelativeStatEC','RelativeStatFSR','TimePtEta','JER']
...
proc=["TTToSemiLeptonic_1","TTToSemiLeptonic_2","diboson", "dyjetstoll_m-50_ht", "qcd_ht", "st","tttosemileptonic2_nonfiducial","wjetstolnu"]
...
datacard.write("shapes data_obs  *  /nfs/dust/cms/user/hugobg/UHH2_UL/CMSSW_10_6_28/src/UHH2/Analysis/AE/2016_electron/script/Input_undfolding_data_.root $PROCESS\n")
datacard.write("shapes *         *  /nfs/dust/cms/user/hugobg/UHH2_UL/CMSSW_10_6_28/src/UHH2/Analysis/AE/2016_electron/script/Input_undfolding_data_.root $PROCESS_nominal $PROCESS_$SYSTEMATIC\n")
...
datacard.write("st ")
datacard.write("tttosemileptonic2_nonfiducial ")
...
datacard.write("xsec_ttbar lnN 1.05 1.05 - - - - - 1.05 -")
datacard.write("\n")
