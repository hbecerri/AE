...
//--------Unfold----------??
       ...
       for(const string &syst : systs){
            ...
            chreco_ttbar_semi->Add(Form("/nfs/dust/cms/user/hugobg/analysis/electron/uhh2.AnalysisModuleRunner.MC.TTToSemiLeptonic_2016preVFP.root/AnalysisTree",syst.c_str()));
       ...
       for(const string &syst : systs){
            ...
            chreco_ttbar_semi1->Add(Form("/nfs/dust/cms/user/hugobg/analysis/electron/uhh2.AnalysisModuleRunner.MC.TTToSemiLeptonic_2016preVFP%sup.root/AnalysisTree",syst.c_str()));
            TTree *treereco_ttbar_semi1 = (TTree*) chreco_ttbar_semi1;
 
            TChain *chreco_ttbar_semi2 = new TChain("AnalysisTree","");
            chreco_ttbar_semi2->Add(Form("/nfs/dust/cms/user/hugobg/analysis/electron/uhh2.AnalysisModuleRunner.MC.TTToSemiLeptonic_2016preVFP%sdown.root/AnalysisTree",syst.c_str()));
            ...
            string selcuts_boosted_central_2 = "(Ele_pt > 55 && DeepttagN <= 1 && btagN >= 1 && M_tt > 500 && chi2 < 30 && Ak4_add_pt > 100 && angle_theta_opt > 0.25*3.1459 && angle_theta_opt < 0.60*3.1459 && Gen_angle_theta_opt > 0.25*3.1459 && Gen_angle_theta_opt < 0.60*3.1459)";
