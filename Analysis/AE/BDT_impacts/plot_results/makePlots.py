...
for sample in sample_names:
    ...
    hist1_2016post[sample] = _file[sample].Get("muon_2016preVFP_750_900_prefit/%s"%sample)
...
dataHist1_2016pre=data_f.Get("muon_2016preVFP_750_900_prefit/data_obs")
...
for i in range(1, h_ratio.GetNbinsX() + 1):
    ...
    mc_2 = _file[sample].Get("muon_2016preVFP_750_900_prefit/TotalBkg")
