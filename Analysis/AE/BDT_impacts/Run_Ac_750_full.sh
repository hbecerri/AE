...
cp ../2018_muon_BDT/script/muon_2018_750_900.txt .
cp ../2017_muon_BDT/script/muon_2017_750_900.txt .
cp ../2016preVFP_muon_BDT/script/muon_2016preVFP_750_900.txt .
cp ../2016postVFP_muon_BDT/script/muon_2016postVFP_750_900.txt .
  
cp ../2018_electron_BDT/script/electron_2018_750_900.txt .
cp ../2017_electron_BDT/script/electron_2017_750_900.txt .
cp ../2016preVFP_electron_BDT/script/electron_2016preVFP_750_900.txt .
cp ../2016postVFP_electron_BDT/script/electron_2016postVFP_750_900.txt .
  
#combineCards.py muon_2018_750_900=muon_2018_750_900.txt muon_2017_750_900=muon_2017_750_900.txt muon_2016preVFP_750_900=muon_2016preVFP_750_900.txt muon_2016postVFP_750_900=muon_2016postVFP_750_900.txt electron_2018_750_900=electron_2018_750_900.txt electron_2017_750_900=electron_2017_750_900.txt electron_2016preVFP_750_900=electron_2016preVFP_750_900.txt electron_2016postVFP_750_900=electron_2016postVFP_750_900.txt  > AE_750.txt

#combineCards.py muon_2018_750_900=muon_2018_750_900.txt muon_2017_750_900=muon_2017_750_900.txt muon_2016preVFP_750_900=muon_2016preVFP_750_900.txt muon_2016postVFP_750_900=muon_2016postVFP_750_900.txt > AE_750.txt
...
text2workspace.py AE_750.txt -o AE_750.root  -P HiggsAnalysis.CombinedLimit.PhysicsModel:multiSignalModel -m 125 --PO map='.*/Ttbar_in_1:rneg[1,0,20]' --PO map='.*/Ttbar_in_2:r_pos=expr;;r_pos("34480.0597/34345.6129*@0*(100+@1)/(100-@1)",rneg,AE[-0.19,-20,20])' --PO verbose 
...
#export SetParameters="rgx{r.+}=1,AE=-0.19"
#export SetParametersExplicit="r_1=1,r_2=1,r_3=1,AE=-0.19"
#export SetParameterRanges="rgx{r.+}=0.5,2:AE=-10,5"
#export redefineSignalPOIs="AE,r_1,r_2,r_3"
...
combine -M MultiDimFit higgsCombine.snapshot.MultiDimFit.mH125.root --algo singles -v $VERBOSITY --redefineSignalPOIs $redefineSignalPOIs --setParameterRanges $SetParameterRanges --setParameters $SetParametersExplicit --robustFit 1 --cminDefaultMinimizerStrategy 0 -m 125 --saveWorkspace -n .freezeall $ASIMOV --snapshotName MultiDimFit --freezeNuisanceGroups syst
