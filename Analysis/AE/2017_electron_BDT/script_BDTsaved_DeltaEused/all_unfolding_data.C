...
//----obetener_toda_la_informacion_de_entrada--------??
    ...
    chreco_ttbar_semi->Add(Form("/nfs/dust/cms/user/hugobg/analysis/muon/BDT/%s.root/Events",text.c_str()));
...
//--------Unfold----------??
       ...
       chreco_data->Add("/nfs/dust/cms/user/hugobg/analysis/muon/BDT/data.root/Events");
